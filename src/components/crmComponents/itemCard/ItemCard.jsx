                    ...
                    <div className="CRMItemCardRow">
                        ...
                        <div className="CRMItemCardRightCol">
                            ...
                            <table className="CRMItemCardSizesTable">
                                ...
                                <tbody>
                                    {foundItem && foundItem.sizes && sortItemsBySize(foundItem.sizes).map((size, i) => {
                                        if (size.size_type === 'EU')
                                            return (
                                                <tr key={i}>
                                                    ...
                                                    <td>{foundItem.sizes.find(item => item.size_default === size.size && item.size_type === 'SM') ? foundItem.sizes.find(item => item.size_default === size.size && item.size_type === 'SM').size : '/'}</td>
