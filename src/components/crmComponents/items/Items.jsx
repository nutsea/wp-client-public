                                                                ...
                                                                <td style={{ width: 0, padding: 0 }}>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="ThumbPrice Blue">
                                                                            {FormatPrice.formatPrice(item.minPrice / 100)} ¥ - {FormatPrice.formatPrice(item.maxPrice / 100)} ¥
                                                                        </div>
                                                                        <div className="ThumbPrice Orange">
                                                                            {FormatPrice.formatPrice(item.minPrice / 100 * constants.course)} ₽ - {FormatPrice.formatPrice(item.maxPrice / 100 * constants.course)} ₽*
                                                                        </div>
