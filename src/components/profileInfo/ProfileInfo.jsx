...
export const ProfileInfo = ({ user, nameProp, surnameProp, phoneProp, onSendUpdate }) => {
    ...
    return (
        <div className="ProfileInfo">
            ...
            <div className="ProfileTip">Заполните данные сразу, и они <b>автоматически будут применяться</b> при оформлении заказа</div>
            <div className="ProfileInputs">
                ...
                <div className="InputsRow">
                    <div className="ProfileInputBox">
                        ...
                        <div className="InputRelative">
                            {/* {user && user.phone &&
                                <div className="InputInfo">{formatPhone(user.phone)}</div>
                            } */}
                        ...
                        <span>Номер телефона необходим для оформления заказа</span>
                    </div>
                    {/* <div className="ProfileInputBox">
                        <label>Email</label>
                        <div className="InputRelative">
                        ...
                        <span>Получайте информацию о состоянии статуса ваших заказов</span>
                    </div> */}
                </div>
            </div>
